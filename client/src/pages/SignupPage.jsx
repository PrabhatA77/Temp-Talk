...
const SignupPage = ({ isModal }) => {
    ...
    return (
        <div className={`flex justify-center items-center ${isModal ? "" : "min-h-screen"}`}>
            <div className={`relative border border-emerald-500/30 p-8 flex flex-col justify-center items-center gap-3 bg-[#0d1412] rounded-3xl shadow-[0_0_40px_rgba(16,185,129,0.15)] ${isModal ? "w-full sm:w-[450px]" : "min-h-96 w-full max-w-md sm:max-w-lg"}`}>
                <motion.div
                    className='font-semibold text-emerald-400 text-3xl md:text-4xl pb-4 mb-2 pt-2'
